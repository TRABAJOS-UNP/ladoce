...
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('0005', 'Visitante', 'Un visitante cualquiera de la pagina web', 'VISITANTE');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('0006', 'Cliente', 'Un cliente que realiza la reserva, debidamente logeado', 'CLIENTE');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('0007', 'Operador', 'Un operador que Adm. una sede, debidamente logeado', 'OPERADOR');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('0008', 'Gerente', 'El gerente, Adm. del sistema, debidamente logeado', 'GERENTE');
