...
START TRANSACTION;
USE `BDLA12`;
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('0', 'Habilitado', 'se le permite usar el sistema', 'HABILITADO');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('1', 'Dehabilitado', 'No se le permite usar el sistema', 'DESHABILITADO');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('2', 'En Proceso', 'La reserva esta esperando a ser exitosa', 'EN_PROCESO');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('3', 'Anulada', 'La reserva fue anulada por quien la creo', 'ANULADA');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('4', 'Fallida', 'La reserva no concluyo con exito', 'FALLIDA');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('5', 'Exitosa', 'La reserva ha concluido con exito', 'EXITOSA');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('6', 'Visitante', 'Un visitante cualquiera de la pagina web', 'VISITANTE');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('7', 'Cliente', 'Un cliente que realiza la reserva, debidamente logeado', 'CLIENTE');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('8', 'Operador', 'Un operador que Adm. una sede, debidamente logeado', 'OPERADOR');
INSERT INTO `BDLA12`.`Parametro` (`codigo`, `descripcionCorta`, `descripcion`, `valor`) VALUES ('9', 'Gerente', 'El gerente, Adm. del sistema, debidamente logeado', 'GERENTE');
