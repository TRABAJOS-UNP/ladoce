		...
		if(a.getAttribute("tipo")!=null){
			...
			if(tipo.equals("0008")){
				funciones= " <ul class='nav navbar-nav navbar-right'>"
						...
						+ "<li><a href='admin_reservas.action'>Administrar Reservas</a></li>"
						+ "<li><a href='modificar_sede.action'>Modificar Sedes</a></li>"
			...
			if(tipo.equals("0009")){
				funciones= " <ul class='nav navbar-nav navbar-right'>"
						...
						+ "<li><a href='admin_sedes.action'>Administrar Sedes</a></li>"
						+ "<li role='separator' class='divider'></li>"
						+ "<li><a href='cerrar.action'>Cerrar Sessión</a></li>"
						+ "</ul>"
						+ "</li>"
